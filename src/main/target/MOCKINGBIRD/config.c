...
void targetConfiguration(void)
{
    ...
    pidProfilesMutable(2)->dyn_lpf_dterm_min_hz = 200;
    pidProfilesMutable(2)->vbatPidCompensation = true;
    pidProfilesMutable(2)->iterm_relax = ITERM_RELAX_RP;
    pidProfilesMutable(2)->pidSumLimit = 1000;
    pidProfilesMutable(2)->pidSumLimitYaw = 1000;
    pidProfilesMutable(2)->pid[PID_PITCH].P = 50;
    pidProfilesMutable(2)->pid[PID_PITCH].I = 80;
    pidProfilesMutable(2)->pid[PID_PITCH].D = 50;
    pidProfilesMutable(2)->pid[PID_PITCH].F = 100;
    pidProfilesMutable(2)->pid[PID_ROLL].P  = 90;
    pidProfilesMutable(2)->pid[PID_ROLL].I  = 80;
    pidProfilesMutable(2)->pid[PID_ROLL].D  = 50;
    pidProfilesMutable(2)->pid[PID_ROLL].F  = 100;
    pidProfilesMutable(2)->pid[PID_YAW].P   = 100;
    pidProfilesMutable(2)->pid[PID_YAW].I   = 0;
    pidProfilesMutable(2)->pid[PID_YAW].D   = 55;
    pidProfilesMutable(2)->pid[PID_LEVEL].P = 100;
    pidProfilesMutable(2)->pid[PID_LEVEL].I = 30;
    pidProfilesMutable(2)->pid[PID_LEVEL].D = 80;
    pidProfilesMutable(2)->levelAngleLimit  = 65;
    ...
    pidProfilesMutable(2)->use_integrated_yaw = true;
    pidProfilesMutable(2)->d_min[FD_ROLL] = 0;
    pidProfilesMutable(2)->d_min[FD_PITCH] = 0;
    pidProfilesMutable(2)->d_min_gain = 20;
    ...
    pidProfilesMutable(1)->pid[PID_PITCH].I = 75;
    pidProfilesMutable(1)->pid[PID_PITCH].D = 95;
    pidProfilesMutable(1)->pid[PID_PITCH].F = 140;
    pidProfilesMutable(1)->pid[PID_ROLL].I  = 75;
    pidProfilesMutable(1)->pid[PID_ROLL].D  = 85;
    pidProfilesMutable(1)->pid[PID_ROLL].F  = 140;
    ...
    pidProfilesMutable(0)->pid[PID_LEVEL].I = 90;
    ...
    controlRateProfilesMutable(0)->dynThrPID = 75;
    ...
    controlRateProfilesMutable(1)->dynThrPID = 65;
    controlRateProfilesMutable(1)->dynThrPID = 75;
    controlRateProfilesMutable(1)->tpa_breakpoint = 1750;
    ...
    controlRateProfilesMutable(2)->dynThrPID = 75;
    controlRateProfilesMutable(2)->tpa_breakpoint = 1750;
    ...
    batteryConfigMutable()->vbatmaxcellvoltage = 100;
